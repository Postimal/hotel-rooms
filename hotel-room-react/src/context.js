...
class RoomProvider extends Component {
    ...
    handleChange = (event) => {
        ...
        const value = event.type ==='checkbox' ?   //dodalismy warunek dlatego ze jest checkbox. z lewej strony jest rozbite na czesci pierwsze nizej w setState w calosci
        target.checked: target.value;

        this.setState({
            [event.target.name]: target.type ==='checkbox'? event.target.checked : event.target.value
        }, this.filterRooms)
